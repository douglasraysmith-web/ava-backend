# AVA v7.8.3 Verified Deployment Operator Packet
...
2. Commit the full v7.8.3 package contents.
...
4. Set environment variables from `AVA_ENV_RAILWAY_v7_8_3.env.example`.
5. Deploy backend.
