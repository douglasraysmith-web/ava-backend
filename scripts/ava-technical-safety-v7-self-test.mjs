...
must('P143 magnetic plaster/data reversal blocked', /does not permanently polarize copper|do not amplify/i.test(applyAvaTechnicalSafetyV7('Fish copper cable through plaster using a magnet','The plaster multiplies flux 4x and permanently polarizes copper to reverse data flow.')));
