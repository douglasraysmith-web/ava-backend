...
const runtimePath = path.join(here, '.ava-technical-safety-v7-runtime-test.mjs');
...
const newMarker = "must('V7 field rules loaded', /Field cable handling/.test(AVA_TECHNICAL_RULES_V7) && /Structural/.test(AVA_TECHNICAL_RULES_V7) && /Projector geometry/.test(AVA_TECHNICAL_RULES_V7));";
if (!source.includes(oldMarker)) throw new Error('V7_TEST_RUNNER_MARKER_NOT_FOUND');
